    ...
    <div className="container mx-auto p-6">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="scoring-1">
          ...
          <div>
            Pertanyaan berikut merupakan penilaian terhadap anggota kelompok,
            bukan Anda sendiri. Harap menilai kinerja masing-masing anggota
            kelompok dengan jujur karena penilaian yang Anda berikan tidak akan
          ...
          <select name="kontribusi1" ref={register}>
            <option value="1">
              Jarang memberikan ide yang berguna ketika berpartisipasi dalam
              kelompok dan diskusi dalam kelas. Mungkin menolak untuk ikut
              berpartisipasi
            </option>
            <option value="2">
              Terkadang memberikan ide yang berguna ketika berpartisipasi dalam
              kelompok dan diskusi dalam kelas. Anggota kelompok yang melakukan
              apa yang diperlukan
            </option>
            <option value="3">
              Biasanya memberikan ide yang berguna ketika berpartisipasi dalam
              kelompok dan diskusi dalam kelas. Anggota kelompok yang berusaha
              keras.
            </option>
            <option value="4">
              Secara rutin memberikan ide yang berguna ketika berpartisipasi
              dalam kelompok dan diskusi dalam kelas. Seorang pemimpin yang
              menyumbang banyak usaha.
            </option>
          </select>
          <div>Pemecahan Masalah</div>
          <select name="pemecahanMasalah1" ref={register}>
            <option value="1">
              Tidak mencoba memecahkan masalah atau tidak membantu oarang lain
              memecahkan masalah. Memungkinkan orang lain melakukan pekerjaan.
            </option>
            <option value="2">
              Tidak menyarankan atau tidak memberikan solusi, tetapi mau mencoba
              solusi yang disarankan oleh orang lain
            </option>
            <option value="3">
              Menyempurnakan solusi yang disarankan oleh orang lain
            </option>
            <option value="4">
              Secara aktif mencari dan menyarankan solusi utuk masalah yang
              dihadapi
            </option>
          </select>
          <div>Sikap</div>
          <select name="sikap1" ref={register}>
            <option value="1">
              Sering mengkritik tugas atau pekerjaan anggota lain dalam kelompok
              secara terbuka. Selalu bersikap negatif tentang tugas yang
              diberikan.
            </option>
            <option value="2">
              Terkadang secara terbuka mengkritik tugas atau pekerjaan anggota
              lain dalam kelompok. Biasanya memiliki sikat positif tentang tugas
              yang diberikan.
            </option>
            <option value="3">
              Jarang secara terbuka mengkritik tugas atau pekerjaan anggota lain
              dalam kelompok. Seringkali memiliki sikat positif tentang tugas
              yang diberikan.
            </option>
            <option value="4">
              Tidak pernah secara terbuka mengkritik tugas atau pekerjaan
              anggota lain dalam kelompok. Selalu memiliki sikat positif tentang
          ...
          <select name="fokusTerhadapTugas1" ref={register}>
            <option value="1">
              Jarang fokus pada tugas dan apa yang perlu dilakukan. Memungkinkan
              orang lain melakukan pekerjaan.
            </option>
            <option value="2">
              Berfokus pada tugas dan apa yang perlu dilakukan dalam beberapa
              waktu. Anggota kelompok lainnya kadang-kadang harus mengingatkan
              supaya mengerjakan tugas.
            </option>
            <option value="3">
              Berfokus pada tugas dan apa yang perlu dilakukan dalam sebagian
              besar waktu untuk menyelesaikannya. Anggota kelompok lain dapat
              mengandalkan orang ini.
            </option>
            <option value="4">
              Secara konsisten tetap fokus pada tugas dan apa yang perlu
              dilakukan. Sangat mandiri.
            </option>
          </select>
          <div>Bekerja dengan orang lain</div>
          <select name="bekerjaDenganOrangLain1" ref={register}>
            <option value="1">
              Jarang mendengarkan, berbagi, dan mendukung upaya anggota lain
              dalam kelompok. Seringkali bukan anggota kelompok yang bagus.
            </option>
            <option value="2">
              Seringkali mendengarkan, berbagi, dan mendukung upaya anggota lain
              dalam kelompok, tetapi terkadang bukan sebagai anggota kelompok
              yang baik.
            </option>
            <option value="3">
              Biasanya mendengarkan, berbagi, dan mendukung upaya anggota lain
              dalam kelompok. Tidak menyebabkan perselisihan dalam kelompok.
            </option>
            <option value="4">
              Hampir selalu mendengarkan, berbagi, dan mendukung upaya anggota
              lain dalam kelompok. Mencoba untuk membuat anggota lain
              bekerjasama dengan baik dalam kelompok.
            </option>
          </select>
          <div>
            Apakah masih ada anggota kelompok lain yang ingin Anda nilai?
          </div>
